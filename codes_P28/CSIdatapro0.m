function [Rx1,Rx2,sequence] = CSIdatapro0 (oridata,format,nRx)
...
if isempty(amplitude)
    ...
    %interpolation
    %%%%%
    [row_pkg,col_sub] = size(amplitude);
    ...
    for num = 1:num_matrix
        matrix_amp=zeros(4096, col_sub);%initialize csi container
        matrix_pha=zeros(4096, col_sub);
